...
public class GUI extends JFrame {
    ...
    public GUI() {
        ...
        setSize(1000, 700); // حجم النافذة
        setDefaultCloseOperation(EXIT_ON_CLOSE);
        setLayout(new BorderLayout());

        Color sidebarColor = new Color(161, 204, 209); // الأزرق الفاتح
Color formBackgroundColor = new Color(244, 242, 222); // الأبيض الكريمي
Color tableBackgroundColor = new Color(233, 179, 132); // البرتقالي الخفيف
Color buttonColor = new Color(124, 157, 150); // الأخضر الداكن
Color buttonTextColor = Color.WHITE; // نص الأزرار أبيض
Color tableTextColor = Color.BLACK; // النص داخل الجدول أسود
Color headerColor = new Color(161, 204, 209); // الأزرق الفاتح



        // Sidebar (لون فقط بدون أزرار)
        JPanel sidebar = new JPanel();
        sidebar.setBackground(sidebarColor);
        sidebar.setPreferredSize(new Dimension(200, getHeight())); // زيادة حجم الـ sidebar
        ...
        addButton.setFont(new Font("Arial", Font.PLAIN, 14)); // تقليل الحجم الكبير للأزرار
        deleteButton.setFont(new Font("Arial", Font.PLAIN, 14));
        updateButton.setFont(new Font("Arial", Font.PLAIN, 14));

        // ترتيب الحقول والأزرار
        ...
        exitButton.setBackground(new Color(255, 69, 0)); // لون أحمر
        exitButton.setForeground(buttonTextColor);
        exitButton.setFont(new Font("Arial", Font.PLAIN, 14)); // تقليل الحجم
